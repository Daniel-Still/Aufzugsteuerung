...
int fuenfter_Stock_von_oben_state = 1;
int get_fuenfter_Stock_von_oben_state()
{
    return fuenfter_Stock_von_oben_state;
}
...
void func_fuenfter_Stock_von_oben(void)
{
    switch(fuenfter_Stock_von_oben_state)
    {
        case check_Haltebedingung:
            if((Stockwerk_gerufen[5] == 1) || (Notrufbetrieb == 1))
            {
                fuenfter_Stock_von_oben_state = warte_auf_Position;
            }
            else if( (stepper1.currentPosition() - Pos_Stockwerk_5  ) < max_brems_steps) 
            {
                stepper1.move(Pos_Stockwerk_4 - stepper1.currentPosition() );
                Hauptfunktionen_state = vierter_Stock_von_oben;
                fuenfter_Stock_von_oben_state = check_Haltebedingung;
            }
        ...
        case warte_auf_Position:
            ...
            {
                fuenfter_Stock_von_oben_state = Tuer_oeffnen;
            }
            break;
        ...
        case Tuer_oeffnen:
            ...
            if(Timer_Tuer_oeffnen.TIMER_ALARM == 1)
            {
                ...
                if(Notrufbetrieb == 0)
                {
                    fuenfter_Stock_von_oben_state = Tuer_schliessen;                 
                }           
            }
        ...
        case Tuer_schliessen:
            ...
            if(Timer_Tuer_schliessen.TIMER_ALARM == 1)
            {
                ...
                fuenfter_Stock_von_oben_state = check_Anforderung;            
            }
        ...
        case check_Anforderung:
            ...
            else
            {
                ...
                if( (niedrigeres_Stockwerk_anfahren == 0) && (Stockwerk_gerufen[6] == 1) )
                {
